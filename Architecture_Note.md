...
- This branching model suited our purposes as we were a small group with three members and the minimised merge complexity helped us understand the various changes or updates that were being implemented. For each new feature or update we created a pull request to integrate the feature branch back into the master. Throughout the course of the project we had a total of 23 pull requests opened and merged into the master once checked.
